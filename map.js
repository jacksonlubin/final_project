...
function ready(error, data, us) {
	...
	countyShapes
		.on("mouseover", function(d) {
			...
			"<table><tbody><tr><td class='wide'>Production in 2008:</td><td>" + formatPercent((d.properties.years[2008][0].production)/100) + "</td></tr>" +
			"<tr><td>Production in 2017:</td><td>" + formatPercent((d.properties.years[2017][0].production)/100) + "</td></tr>" +
			"<tr><td>Change:</td><td>" + formatPercent((d.properties.years[2017][0].production-d.properties.years[2008][0].production)/100) + "</td></tr></tbody></table>"
			)
	...
	function update(year){
		...
		countyShapes.style("fill", function(d) {
			return color(d.properties.years[year][0].production)
		});
	}
